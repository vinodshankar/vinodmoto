	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.beginPath();<br>	ctx.moveTo(50,20);<br>	ctx.###CONTEXTPROP###;<br>	ctx.stroke();<br>"	
	...
	var para2=")"
			...
			var x="arcTo" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="arcTo" + para1 + fnutt + val + fnutt + para2;
