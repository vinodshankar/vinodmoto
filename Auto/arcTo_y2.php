	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="100,50,100,100,50" checked='checked' /><label for="value_1">100,50,100,100,50</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="100,50,100,00,50" /><label for="value_2">100,50,100,00,50</label></div>
	...
	ctx.stroke();
			...
			var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.beginPath();<br>	ctx.moveTo(50,50);<br>	ctx.arcTo(<span id='enlargecontextprop'>100,50,100,100,50)</span>;<br>	ctx.stroke();<br>
