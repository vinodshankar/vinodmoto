	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.fillStyle='red';<br>	ctx.fillRect(0,0,300,150);<br>	ctx.fillStyle='yellow';<br>	ctx.fillRect(40,40,150,100);<br>	ctx.strokeRect(30,10,150,100);<br>	ctx.###CONTEXTPROP###;<br>"	
	...
	var para2=")"
			...
			var x="clearRect" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="clearRect" + para1 + fnutt + val + fnutt + para2;
