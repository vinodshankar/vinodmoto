...
<div id="demo-top-bar"><div id="demo-bar-inside"><h2 id="demo-bar-badge">CSS-Tricks Example</h2><div id="demo-bar-buttons"><a class='header-button' href='/css3-gradients/'>&larr; Back to Article</a> &nbsp; <a class='header-button' href='/examples/'>More Demos &rarr;</a></div><div id="demo-bar-ad"><div id="bsap_1255488" class="bsarocks bsap_3469a2a501a9e18091036aa0c89f9dcb"></div><a href="http://adpacks.com" id="bsap_aplink">via Ad Packs</a></div></div></div> 
	...
	<div id="content">
		...
		<h1>CSS3 Gradient Backgrounds</h1>
		
		
		
		
		<h2>Linear Gradient (Top &rarr; Bottom)</h2>
		
		<div id="linearBg2"></div>
		<style scoped contenteditable spellcheck="off">#linearBg2 {
  /* fallback */
  ...
  background: -o-linear-gradient(top, #2F2727, #1a82f7);
		...
		<h2>Linear Gradient (Left &rarr; Right)</h2>
		
		<div id="linearBg1"></div>
		
		<style scoped contenteditable>#linearBg1 {
  /* fallback */
  background-color: #1a82f7;
...
<h2>Linear Gradient (with Even Stops)</h2>
		...
		<div id="even-stops"></div>
		
		<style scoped contenteditable>#even-stops {
  /* fallback DIY*/
...
<h2>Linear Gradient (with Specified Arbitrary Stops)</h2>
		...
		<div id="arbitrary-stops"></div>
		
		<style scoped contenteditable>#arbitrary-stops {
  /* fallback DIY*/
  ...
  background: -o-linear-gradient(left, #2F2727, #1a82f7 5%, #2F2727, #1a82f7 95%, #2F2727);
		...
		<style scoped contenteditable>#radial-center {
  /* fallback */
  ...
  <div id="radial-position"></div>
  <style scoped contenteditable>#radial-position {
  /* fallback */
  background-color: #2F2727;
  ...
  /* Opera cannot do radial gradients yet */
	...
	<p>Shape keywords: circle, ellipse</p>
	<p>Size keywords: closest-side, closest-corner, farthest-side, farthest-corner, contain, cover</p>
...
<style type="text/css" style="display: none;">
	...
	#demo-top-bar {
		height: 83px; 
		background: #eee url(/wp-content/themes/CSS-Tricks-9/images/bglines.png) !important;
