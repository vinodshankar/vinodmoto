	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	var img=document.createElement('image');<br>	img.src='the_scream.jpg';<br>	ctx.###CONTEXTPROP###;<br>"	
