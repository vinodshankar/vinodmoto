	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="100,75,50,0*Math.PI,1.5*Math.PI,true" checked='checked' /><label for="value_1">100,75,50,0*Math.PI,1.5*Math.PI,true</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="100,75,50,0*Math.PI,1.5*Math.PI,false" /><label for="value_2">100,75,50,0*Math.PI,1.5*Math.PI,false</label></div>
	...
	ctx.beginPath();
	ctx.arc(100,75,50,0*Math.PI,1.5*Math.PI,true);
	ctx.stroke();
			...
			var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.beginPath();<br>	ctx.arc(<span id='enlargecontextprop'>100,75,50,0*Math.PI,1.5*Math.PI,true)</span>;<br>	ctx.stroke();<br>
