	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="100,75,50,0.1*Math.PI,1.5*Math.PI" /><label for="value_2">100,75,50,0.1*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="100,75,50,0.2*Math.PI,1.5*Math.PI" /><label for="value_3">100,75,50,0.2*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="100,75,50,0.5*Math.PI,1.5*Math.PI" /><label for="value_4">100,75,50,0.5*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="100,75,50,1*Math.PI,1.5*Math.PI" /><label for="value_5">100,75,50,1*Math.PI,1.5*Math.PI</label></div>
