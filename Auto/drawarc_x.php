	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="150,75,50,0*Math.PI,1.5*Math.PI" /><label for="value_2">150,75,50,0*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="200,75,50,0*Math.PI,1.5*Math.PI" /><label for="value_3">200,75,50,0*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="300,75,50,0*Math.PI,1.5*Math.PI" /><label for="value_4">300,75,50,0*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="400,75,50,0*Math.PI,1.5*Math.PI" /><label for="value_5">400,75,50,0*Math.PI,1.5*Math.PI</label></div>
