	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="100,100,50,0*Math.PI,1.5*Math.PI" /><label for="value_2">100,100,50,0*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="100,150,50,0*Math.PI,1.5*Math.PI" /><label for="value_3">100,150,50,0*Math.PI,1.5*Math.PI</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="100,300,50,0*Math.PI,1.5*Math.PI" /><label for="value_4">100,300,50,0*Math.PI,1.5*Math.PI</label></div>
