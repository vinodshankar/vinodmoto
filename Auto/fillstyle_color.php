	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<div style="font-size:14px;margin:10px;font-weight:bold;">fillStyle:</div>				
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="rgb(0,255,0)" /><label for="value_5">rgb(0,255,0)</label></div>
	...
	ctx.fillRect(20,20,150,100);
			...
			var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.fillStyle=<span id='enlargecontextprop'>'#000000'</span>;<br>	ctx.fillRect(20,20,150,100);<br>
