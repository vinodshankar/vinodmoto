	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.fillStyle='red';<br>	ctx.fillRect(20,20,75,50);<br>	ctx.fillStyle='blue';	<br>	ctx.###CONTEXTPROP###;<br>	ctx.fillRect(50,50,75,50);<br>"	
	...
	var para2=""
			...
			var x="globalAlpha" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="globalAlpha" + para1 + fnutt + val + fnutt + para2;
