	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.fillStyle='blue';<br>	ctx.fillRect(10,10,50,50);<br>	ctx.###CONTEXTPROP###;<br>	ctx.beginPath();<br>	ctx.fillStyle='red';<br>	ctx.arc(50,50,30,0,2*Math.PI);<br>	ctx.fill();<br>"	
	...
	var para2=""
			...
			var x="globalCompositeOperation" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="globalCompositeOperation" + para1 + fnutt + val + fnutt + para2;
