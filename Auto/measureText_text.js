	...
	var y="var c=document.getElementById('myCanvas');<br>	var ctx=c.getContext('2d');<br>	ctx.font='30px Arial';<br>	var m=ctx.###CONTEXTPROP###;<br>	ctx.fillText(m.width,10,30);<br>"	
	...
	var para2=")"
			...
			var x="measureText" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="measureText" + para1 + fnutt + val + fnutt + para2;
