function playit_onload()
	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.lineWidth=10;	<br>	ctx.lineJoin='miter';		<br>	ctx.###CONTEXTPROP###;			<br>	ctx.moveTo(20,20);<br>	ctx.lineTo(50,30);<br>	ctx.lineTo(20,40);<br>	ctx.stroke();<br>"	
	...
	var para2=""
			...
			var x="miterLimit" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="miterLimit" + para1 + fnutt + val + fnutt + para2;
