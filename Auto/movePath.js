	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.beginPath();<br>	ctx.###CONTEXTPROP###;<br>	ctx.lineTo(50,100);<br>	ctx.stroke();<br>"	
	...
	var para2=")"
			...
			var x="moveTo" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="moveTo" + para1 + fnutt + val + fnutt + para2;
