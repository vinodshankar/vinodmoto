	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.###CONTEXTPROP###;<br>	ctx.strokeRect(20,20,150,100);<br>"	
	...
	var para2=""
			...
			var x="strokeStyle" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="strokeStyle" + para1 + fnutt + val + fnutt + para2;
