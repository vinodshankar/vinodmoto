	...
	<div id="playitcontainer">
		...
		<div style="width:450px;float:left;">
				...
				<form style="margin:15px;" action="javascript:return false;">
					...
					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="'How are you today?',20,50" /><label for="value_2">'How are you today?',20,50</label></div>

					

					<div><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="'It is a great day!',20,50" /><label for="value_3">'It is a great day!',20,50</label></div>
