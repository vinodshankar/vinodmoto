	...
	var y="var canvas=document.getElementById('myCanvas');<br>	var ctx=canvas.getContext('2d');<br>	ctx.###CONTEXTPROP###;<br>	ctx.fillStyle='lightblue';<br>	ctx.fillRect(50,50,250,100);<br>	ctx.fillStyle='red';<br>	ctx.font='30px Arial';<br>	ctx.fillText('Transform', 60,80);<br>"	
	...
	var para2=")"
			...
			var x="setTransform" + para1 + "<span id='enlargecontextprop'>" + fnutt + val + fnutt + "</span>" + para2
	...
	ctx.clearRect(0,0,430,280);
		...
		var x="setTransform" + para1 + fnutt + val + fnutt + para2;
